...
#define THREAD_COUNT (get_cpu_threads())
...
#define BASELINE_SCORE 1000
#define MAX_SCORE 999999999999

#define INTEGER_OPS_COUNT 1000000000
#define FLOATING_POINT_OPS_COUNT 500000000
#define BITWISE_OPS_COUNT 500000000
#define BRANCH_TEST_COUNT 500000000
#define MEMORY_BANDWIDTH_SIZE 500000000
#define CACHE_TEST_SIZE 100000000
#define MEMORY_LATENCY_TEST_COUNT 1000000000
...
int main() {
    ...
    printf("开始单核整数运算测试...\n");
    double single_core_integer_score = measure_time(integer_operations);
    printf("单核整数运算分数: %.2f\n", single_core_integer_score);

    printf("开始单核浮点运算测试...\n");
    double single_core_floating_point_score = measure_time(floating_point_operations);
    printf("单核浮点运算分数: %.2f\n", single_core_floating_point_score);

    printf("开始单核位操作测试...\n");
    double single_core_bitwise_score = measure_time(bitwise_operations);
    printf("单核位操作分数: %.2f\n", single_core_bitwise_score);

    printf("开始单核分支预测测试...\n");
    double single_core_branch_score = measure_time(branch_prediction_test);
    printf("单核分支预测分数: %.2f\n", single_core_branch_score);

    printf("开始多线程整数运算测试...\n");
    double multi_thread_integer_score = measure_time(multi_thread_test);
    printf("多线程整数运算分数: %.2f\n", multi_thread_integer_score);
    ...
    double total_single_core_score = single_core_integer_score + single_core_floating_point_score + single_core_bitwise_score + single_core_branch_score;
    double total_multi_core_score = multi_thread_integer_score + memory_bandwidth_score + cache_score + memory_latency_score + encryption_score + compression_score;

    printf("单核综合得分: %.2f\n", total_single_core_score);
    printf("多核综合得分: %.2f\n", total_multi_core_score);
